...
fruit_type_map <-
    tribble(
        ...
        'green', NA,
        'berry-like', NA,
        'depressed-globose or slightly oblong', NA,
        'subglobose', NA,
        'oblong/ ellipsoid', NA,
        'fused as syncarps', NA,
        'fused fruiting heads', NA,
        'fruiting heads', NA,
        'lobed', NA,
        'pod', "legume",
        'loculicidal capsules', NA,
        'drupaceous carpel?', NA,
        'berry-like carpel', NA,
        'globose', NA,
        'round', NA,
        'obovoid', NA,
